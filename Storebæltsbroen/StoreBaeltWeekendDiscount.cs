...
{
    public class StoreBaeltWeekendDiscount : BridgeCrossing
    {

        public StoreBaeltWeekendDiscount(bool broBizzDiscount, DateTime date) : base(broBizzDiscount, date)
        {
        ...
        public override double CalculateDiscountPrice(bool broBizzDiscount)
        {
            ...
            if ((Date.DayOfWeek == DayOfWeek.Saturday ||
                Date.DayOfWeek == DayOfWeek.Sunday) && Vehicle().Contains("Car"))
            {
